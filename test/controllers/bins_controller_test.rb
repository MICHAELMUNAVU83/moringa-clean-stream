...
class BinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bin" do
    assert_difference("Bin.count") do
      post bins_url, params: { bin: { emptied: @bin.emptied, location: @bin.location, waste_level: @bin.waste_level } }
    end
  ...
  test "should update bin" do
    patch bin_url(@bin), params: { bin: { emptied: @bin.emptied, location: @bin.location, waste_level: @bin.waste_level } }
